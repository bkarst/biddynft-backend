class NftsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @nft.save
        format.html { redirect_to @nft, notice: "Nft was successfully created." }
  ...
  def update
    respond_to do |format|
      if @nft.update(nft_params)
        format.html { redirect_to @nft, notice: "Nft was successfully updated." }
  ...
  private
    ...
    def nft_params
      params.require(:nft).permit(:title, :image_url, :supply, :author_image_url)
    end
end

...
class NftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nft" do
    assert_difference('Nft.count') do
      post nfts_url, params: { nft: { author_image_url: @nft.author_image_url, image_url: @nft.image_url, supply: @nft.supply, title: @nft.title } }
    end
  ...
  test "should update nft" do
    patch nft_url(@nft), params: { nft: { author_image_url: @nft.author_image_url, image_url: @nft.image_url, supply: @nft.supply, title: @nft.title } }
